...
#
xrandr --output DP-4  --primary --mode 2560x1440 --rate 144 --gamma 0.7:0.7:0.7 --brightness 1.0
xrandr --output HDMI-0 --mode 1920x1080 --rate 60 --gamma 0.7:0.7:0.7 --brightness 1.0

#start up apps
if pidof vesktop >/dev/null 2>&1; then
	echo "Vesktop already running"
else
	vesktop&
	echo "Vesktop started"
fi
